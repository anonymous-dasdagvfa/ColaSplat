...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.position_lr_max_steps = 3_000 # 30_000
        ...
        self.iterations = 1_0000 

        self.enable_rgb_loss = True 
        self.enable_lang_loss = True 
        
        self.language_loss_coeff = 0.0001
        self.rgb_loss_coeff = 1
        self.admm_loss_coeff = 1
        self.quant_coff = 100 # 0.00005
        ...
        self.quant_start_iter = 100


        self.simp_iteration2 = 9_900 
        self.freeze_center_iter = 9_500 
        self.admm_interval = 50
        self.rho1 = 0.0005
        self.rho2 = 0.0005
        self.pruning_threshold1 = 0.00001
        self.pruning_threshold2 = 0.5

        self.quant = True 
        self.kmeans_ncls = 4096
        self.kmeans_ncls_sh = 8000
        self.kmeans_ncls_dc = 4096
        self.quant_params = ['sh'] # , 'language_feature1', 'language_feature2', 'language_feature3' , 'sh', 'dc', 'scale', 'rot'
